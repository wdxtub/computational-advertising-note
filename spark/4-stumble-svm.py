...
def trainEvaluateModel(trainData, validationData, numIterations, stepSize, regParam):
    ...
    print("训练评估：numIterations->", numIterations, ", stepSize->", stepSize, ", regParam->", regParam)
    print("==> 所需时间:", duration, "s ,AUC=", AUC)
    return (AUC, duration, numIterations, stepSize, regParam, model)

print("找到最佳参数组合，会计算 5x4x3 = 60 遍")
print("===========================")
...
def evalAllParameter(trainData, validationData, numIterationsList, stepSizeList, regParamList):
    ...
    print("最佳参数：numIterations->", bestParameter[2], ", stepSize->", bestParameter[3], ", regParam->", bestParameter[4])
    print("==> 所需时间:", bestParameter[1], "s ,AUC=", bestParameter[0])
    return bestParameter[5]

print("最佳参数组合")
bestModel = evalAllParameter(trainData, validationData, numIterationsList, stepSizeList, regParamList)
print("测试结果")
